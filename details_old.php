    ...
    return number_format($nombre, 0, ',', ' ');
            ...
            if(isset($_GET['id'])) {
               ...
               // $bd=new ConnectMySQLDB('localhost','inflfiel_social_traking','inflfiel_UserSocial',')6WZghEwCWTN');
                ...
                $query_nbr_abonner="SELECT influenceur_name, Facebook, Instagram, Tiktok, Twitter, YouTube
                FROM total_abonner
        ...
        // Initialisez un tableau pour stocker les données d'action
        $actionData = array();

        // Parcourez les résultats et remplissez le tableau actionData
        foreach ($results_chat_4 as $row) {
            $campagne = $row['campagne'];
            $kpi = $row['kpi'];
            
            // Remplissez le tableau avec les données d'action
            $actionData[] = array(
                "campagne" => $campagne,
                "kpi" => $kpi
            );
...
<section class="influencers-section">
    ...
    <div class="container">
                ...
                <h2 class="mb-4">
                    Details De l'Influenceur<?php echo ($date_debut!=null && $date_fin!=null)?" de <strong style='color:blue'> $date_debut </strong > à <strong style='color:blue'> $date_fin</strong>":""; ?>
                </h2>
            ...
            <center>
                    <div class="picture">
                        <img style=" border-radius: 50%;" src="<?php echo $influencer[0]['images']?'https://bo.influxs.live/BO/_lib/file/img/'.$influencer[0]['images']:'profil.png'; ?>" alt="Profile Image">
                    </div>
                    ...
                    <div class="container">
                      <h2>Carte de Présentation d'Objectif Influenceur</h2>
                      <div class="card-container">
                            <div class="col-md-4">
                                <div class="card-a">
                                            ...
                                            <div class="info-a">
                                                <h3>Vidéo</h3>
                                                <p>Nombre Attendue :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($objectif_influenceur['Video']??null)??"Indisponible"?>  </samp></p>
                                                <p>Nombre Realiser :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($nbr_abonner["Facebook"]??null)??"Indisponible"?>  </samp></p>
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-a">
                                            ...
                                            <div class="info-a">
                                                <h3>Post</h3>
                                                <p>Nombre Attendue :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($objectif_influenceur['Post']??null)??"Indisponible"?>  </samp></p>
                                                <p>Nombre Realiser :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($nbr_abonner["Facebook"]??null)??"Indisponible"?>  </samp></p>
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-a">
                                            ...
                                            <div class="info-a">
                                                <h3>Comment</h3>
                                                <p>Nombre Attendue :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($objectif_influenceur['Comment']??null)??"Indisponible"?>  </samp></p>
                                                <p>Nombre Realiser :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($nbr_abonner["Facebook"]??null)??"Indisponible"?>  </samp></p>
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-a">
                                            ...
                                            <div class="info-a">
                                                <h3>Others</h3>
                                                <p>Nombre Attendue :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($objectif_influenceur['Others']??null)??"Indisponible"?>  </samp></p>
                                                <p>Nombre Realiser :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($nbr_abonner["Facebook"]??null)??"Indisponible"?>  </samp></p>
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-a">
                                            ...
                                            <div class="info-a">
                                                <h3>Ayoba</h3>
                                                <p>Nombre Attendue :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($objectif_influenceur['Ayoba']??null)??"Indisponible"?>  </samp></p>
                                                <p>Nombre Realiser :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($nbr_abonner["Facebook"]??null)??"Indisponible"?>  </samp></p>
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card-a">
                                            ...
                                            <div class="info-a">
                                                <h3>Engagement</h3>
                                                <p>Nombre Attendue :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($objectif_influenceur['Engagement']??null)??"Indisponible"?>  </samp></p>
                                                <p>Nombre Realiser :<samp style="font-size: 20px;font-weight: bold;"> <?=separateurMilliers($nbr_abonner["Facebook"]??null)??"Indisponible"?>  </samp></p>
                                            </div>
                                </div>
                            </div>                   
 ...
 $matrix["Nombre des partages "][0] + $matrix["Nombre de likes "][0]
    ...
    <div  class="container mt-4">
        <h2>Tableau d'actions des influenceurs</h2>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: valeurs,
                    backgroundColor: 'rgba(54, 39, 245, 0.2)', // Couleur de remplissage des barres
                    borderColor: 'rgba(54, 39, 245, 1)', // Couleur de bordure des barres
                    borderWidth: 1
                }]
            },
            options: {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: valeurs,
                    backgroundColor: 'rgba(245, 39, 39, 0.2)', // Couleur de remplissage des barres
                    borderColor: 'rgba(245, 39, 39, 1)', // Couleur de bordure des barres
                    borderWidth: 1
                }]
            },
            options: {
