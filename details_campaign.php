    ...
    return number_format($nombre, 0, ',', ' ');
            ...
            if(isset($_GET['campaign_id'])) 
            {
             ...
             //$bd=new ConnectMySQLDB('localhost','inflfiel_social_traking','inflfiel_UserSocial',')6WZghEwCWTN');
                ...
                FROM total_abonner
                WHERE influenceur_id = $campaign_id;";

               $query_objectif_influenceur = "SELECT * FROM objectif_influenceur  WHERE influenceur_id = $campaign_id";
                ...
                WHERE influenceur_id = $campaign_id and publication_date > '2023-01-01'";
...
<!--        </header>-->
        ...
        <?php echo ($date_debut!=null && $date_fin!=null)?" de <strong style='color:blue'> $date_debut </strong > à <strong style='color:blue'> $date_fin</strong>":""; ?>
            ...
            <center>
                    ...
                    <h3><?php echo $influencer[0]['name']; ?></h3>
                    <!-- <div class="info">
        ...
        <div style="margin-top: 5%" class="row">
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="info">
                    <p>
                        <samp style="font-size: 40px;font-weight: bold;">  <?= separateurMilliers($matrix?($matrix["Nombre de vues "]?$matrix["Nombre de vues "][0]:0):0)?></samp>
                        </p>
                        <h4>Total Vues</h4>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="info">
                       <p>
                        <samp style="font-size: 40px;font-weight: bold;">  <?= separateurMilliers($matrix?($matrix["Nombre des partages "]?$matrix["Nombre des partages "][0]:0):0)?></samp>
                        </p>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="info">
                       <p>
                        <samp style="font-size: 40px;font-weight: bold;">  <?= separateurMilliers($matrix?( $matrix["Nombre de likes "]?$matrix["Nombre de likes "][0]:0):0)?></samp>
                        </p>
                        <h4>Total Likes</h4>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="info">
                    <p>
                        <samp style="font-size: 40px;font-weight: bold;">  <?=separateurMilliers($matrix? ($matrix["Nombre de commentaires "]?$matrix["Nombre de commentaires "][0]:0):0)?></samp>
                        </p>
            ...
            <?php
                    $Total__engagement=
 ($matrix? ($matrix["Nombre de commentaires "]?$matrix["Nombre de commentaires "][0]:0):0)+
 ($matrix?($matrix["Nombre de vues "]?$matrix["Nombre de vues "][0]:0):0)+
 ($matrix?($matrix["Nombre des partages "]?$matrix["Nombre des partages "][0]:0):0) + ($matrix?( $matrix["Nombre de likes "]?$matrix["Nombre de likes "][0]:0):0)
                    ?>
    ...
    new Chart(ctx, {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: campagnes,
                datasets: [{
                    label: 'Engagement par Influenceur',
                    data: valeurs,
...
new Chart(ctx, {
    ...
    data: {
        labels: labels,
        datasets: [{
            label: "Nombre d\'action par Influenceur",
            data: values,
